...
/// An implementation of [ZdcMapsFlutterPlatform] that uses [MethodChannel] to communicate with the native code.
///
/// The `google_maps_flutter` plugin code itself never talks to the native code directly. It delegates
/// all those calls to an instance of a class that extends the ZdcMapsFlutterPlatform.
///
...
class MethodChannelZdcMapsFlutter extends ZdcMapsFlutterPlatform {
  ...
  /// Set [ZdcMapsFlutterPlatform] to use [AndroidViewSurface] to build the Zdc Maps widget.
  ///
  /// This implementation uses hybrid composition to render the Zdc Maps
  ...
  Widget _buildView(
    ...
    const viewType = 'vn.duypx/zdc_maps';
