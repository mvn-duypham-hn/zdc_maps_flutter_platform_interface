...
/// The interface that platform-specific implementations of `zdc_maps_flutter` must extend.
///
...
///
/// Do `extends ZdcMapsFlutterPlatform` instead, so new methods added here are
...
abstract class ZdcMapsFlutterPlatform extends PlatformInterface {
  ...
  /// class that extends [ZdcMapsFlutterPlatform] when they register themselves.
  ...
  /// cleared from the map after calling this method. The Zdc Maps SDK maintains a small
  ...
  /// Populates [ZdcMapsFlutterInspectorPlatform.instance] to allow
