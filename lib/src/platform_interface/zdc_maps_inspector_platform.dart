...
/// `zdc_maps_flutter` can extend to support state inpsection in tests.
///
...
///
/// Do `extends ZdcMapsInspectorPlatform` instead, so new methods
...
abstract class ZdcMapsInspectorPlatform extends PlatformInterface {
  /// Constructs a ZdcMapsFlutterPlatform.
  ZdcMapsInspectorPlatform() : super(token: _token);

  static final Object _token = Object();

  static ZdcMapsInspectorPlatform? _instance;

  /// The instance of [ZdcMapsInspectorPlatform], if any.
  ///
  /// This is usually populated by calling
  /// [ZdcMapsFlutterPlatform.enableDebugInspection].
  static ZdcMapsInspectorPlatform? get instance => _instance;

  /// Platform-specific plugins should set this with their own platform-specific
  /// class that extends [ZdcMapsInspectorPlatform] in their
  /// implementation of [ZdcMapsFlutterPlatform.enableDebugInspection].
  static set instance(ZdcMapsInspectorPlatform? instance) {
    if (instance != null) {
