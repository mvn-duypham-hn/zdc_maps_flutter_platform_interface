...
/// Represents a point coordinate in the [ZdcMap]'s view.
///
...
/// corresponds to top-left of the [ZdcMap] not the whole screen.
@immutable
class ScreenCoordinate {
  /// Creates an immutable representation of a point coordinate in the [ZdcMap]'s view.
  const ScreenCoordinate({
    required this.x,
    required this.y,
  });

  /// Represents the number of pixels from the left of the [ZdcMap].
  final int x;

  /// Represents the number of pixels from the top of the [ZdcMap].
  final int y;
