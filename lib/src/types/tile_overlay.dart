...
/// Uniquely identifies a [TileOverlay] among [ZdcMap] tile overlays.
@immutable
...
/// is ZdcMap.getMinZoomLevel and the maximum zoom level is ZdcMap.getMaxZoomLevel.
///
...
class TileOverlay implements MapsObject<TileOverlay> {
  /// Creates an immutable representation of a [TileOverlay] to draw on [ZdcMap].
  const TileOverlay({
  ...
  ///
  /// Defaults to 256, which is the traditional size of Zdc Maps tiles.
