...
// <https://developers.google.com/android/reference/com/google/android/gms/maps/ZdcMap.html#MAP_TYPE_NORMAL>
enum MapType {
...
// Used with [ZdcMapOptions] to wrap a [LatLngBounds] value. This allows
...
// Used with [ZdcMapOptions] to wrap min and max zoom. This allows
...
///
/// See also: `setStyle` on [ZdcMapController] for why this exception
/// might be thrown.
class MapStyleException implements Exception {
  /// Default constructor for [MapStyleException].
  const MapStyleException(this.cause);

  /// The reason `ZdcMapController.setStyle` would throw this exception.
  final String cause;
}
